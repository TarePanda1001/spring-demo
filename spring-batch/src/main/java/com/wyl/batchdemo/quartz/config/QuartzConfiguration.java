package com.wyl.batchdemo.quartz.config;

import com.wyl.batchdemo.quartz.launcher.QuartzJobLauncher;
...
public class QuartzConfiguration {
    ...
    public CronTriggerFactoryBean cronTriggerFactoryBean(){
        ...
        log.info("------- : " + jobDetailFactoryBean().getObject());
